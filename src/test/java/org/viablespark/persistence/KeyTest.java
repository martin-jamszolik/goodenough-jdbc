...
public class KeyTest {
  ...
  public void testAdd_String_Number() {
    Key mutableKey =
        key.add("Test", 234L).add("Failed", null).add("ThirdDecimal", new BigDecimal("23345.23"));
  ...
  public void testGetKey() {
    ...
    assertTrue(
        "Should be missing key", thrown.getMessage().contains("Key fake not found. Other keys?"));
  }
