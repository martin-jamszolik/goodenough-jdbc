...
public class ContractorRepositoryTest {
  ...
  public void setUp() {
    ...
    db = new EmbeddedDatabaseBuilder().addDefaultScripts().setName("ContractorTest").build();
  ...
  public void testSaveContractor() {
    ...
    assertEquals(
        "contact@johndoeconstruction.com", retrievedContractor.getEmail(), "Email should match");
  }
